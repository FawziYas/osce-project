...
urlpatterns = [
    ...
    path('sessions/<uuid:session_id>/request-pdf/', sessions.request_pdf_async, name='request_pdf_async'),
    ...
    path('examiners/bulk-import-status/', examiners.bulk_import_status, name='bulk_import_status'),
    ...
    path('sessions/<uuid:session_id>/students/upload-status/', students.students_upload_status, name='students_upload_status'),
    ...
    path('reports/session/<uuid:session_id>/results/', reports.reports_session_results, name='reports_session_results'),
